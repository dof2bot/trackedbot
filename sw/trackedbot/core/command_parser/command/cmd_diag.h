 ...
 *
 * @brief Discrete handler for CMD_ID_GET_DIAG (0x11) binary frame.
 */
...
/**
 * @brief Execute query diagnostic command frame.
 *
 ...
 * @param failsafe Optional pointer to failsafe watchdog instance.
 * @return bool true if diagnostic packet was transmitted, false otherwise.
 */
