 ...
 *
 * @brief Discrete handler for CMD_ID_STOP (0x03) binary frame.
 */
...
/**
 * @brief Execute emergency/manual stop command frame.
 *
 ...
 * @param msg_id Command message ID (CMD_ID_STOP).
 * @param len Payload length in bytes (must equal PAYLOAD_LEN_STOP = 0).
 * @return bool true if motors stopped and response transmitted, false otherwise.
 */
bool cmd_stop_execute(
