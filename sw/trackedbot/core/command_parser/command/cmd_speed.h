 ...
 *
 * @brief Discrete handler for CMD_ID_SET_SPEED (0x02) binary frame.
 */
...
/**
 * @brief Execute set speed command frame.
 *
 ...
 * @param msg_id Command message ID (CMD_ID_SET_SPEED).
 * @param payload Pointer to payload buffer containing PWM speed value.
 * @param len Payload length in bytes (must equal PAYLOAD_LEN_SET_SPEED = 1).
 * @return bool true if speed set and response transmitted, false otherwise.
 */
